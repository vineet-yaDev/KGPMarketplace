  ...
  return (
    <section className="px-4 pt-6">
      <div className="container mx-auto max-w-6xl">
        {/* Scroll wrapper with relative positioning */}
        <div className="relative overflow-x-auto -mx-4 px-4">
          {/* Fade overlay on right edge to indicate scroll */}
          <div className="pointer-events-none absolute top-0 right-0 h-full w-12 bg-gradient-to-l from-white dark:from-black" />

          {/* Horizontal scroll flex container with right padding */}
